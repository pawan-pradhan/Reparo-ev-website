        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              {cities.map((city) => (
                <option key={city._id} value={city._id}>{city.name} ({city.pincode})</option>
              ))}
            </select>
...
//   return (
//     <section className="hero-section min-h-[90vh] flex items-center justify-center relative overflow-hidden">
