...
const ServiceOrders = () => {
  ...
  const downloadInvoice = async (orderId) => {
    ...
    try {
      ...
      const data = await response.json()
      console.log('Invoice Download Response:', data)
      
      if (response.ok && data.success) {
        // If API returns PDF blob
        if (data.pdfUrl) {
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        Quantity: {order.quantity} • Payment: {order.paymentMode?.toUpperCase()}
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col items-start sm:items-end gap-2">
                      ...
                      <div className="flex gap-4">
                        <Link
                          to={`/dashboard/track-order/${order.serviceId}`}
...
//           <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-4">
//             <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
//               <h5 className="font-semibold">All Orders</h5>
//               <input
//                 type="text"
//                 placeholder="Search orders..."
//                 value={searchTerm}
...
//             <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
//               <div className="text-6xl mb-4">📦</div>
//               <h5 className="font-semibold text-lg mb-2">No Orders Found</h5>
...
//                             alert(`Invoice for Order ${order.id} will be available soon.`)
//                           }}
