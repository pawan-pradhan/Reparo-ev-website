...
//       status: 'Open',
//       messages: [
//         { sender: 'user', message: 'Payment failed but amount deducted', time: '10:30 AM' },
//         { sender: 'support', message: 'Please wait, we are checking', time: '10:45 AM' },
//       ]
//     }
//   ])
...
//   //     formData.append('mobile_number', newTicket.mobile_number)
//   //     formData.append('category', newTicket.category)
//   //     formData.append('description', newTicket.message)

//   //     const res = await axios.post(
//   //       `${API_BASE_URL}web/api/create-support-ticket`,
//   //       formData
//   //     )
...
//       const res = await createSupportTicket(newTicket)
...
//               {/* <button
//                 type="submit"
//                 className="mt-4 bg-gradient-to-r from-[#0b86d0] to-[#00c853] text-white px-6 py-2 rounded-lg font-semibold hover:opacity-90 transition"
//               >
//                 Submit Ticket
//               </button> */}
...
//                 type="submit"
//                 disabled={loading}
//                 className="mt-4 bg-gradient-to-r from-[#0b86d0] to-[#00c853] text-white px-6 py-2 rounded-lg"
//               >
//                 {loading ? 'Submitting...' : 'Submit Ticket'}
//               </button>
//             </form>
...
//                     <div>
//                       <h6 className="font-medium">{ticket.subject}</h6>
...
//                                 : 'bg-[#0b86d0]/10 ml-auto max-w-[80%]'
//                             } ${msg.sender === 'support' ? 'text-right' : ''}`}
//                           >
//                             <span className="font-medium">{msg.sender === 'user' ? 'You:' : 'Support:'}</span>
//                             {' '}{msg.message}
...
//                           className="flex-1 border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-[#0b86d0]"
//                         />
//                         <button className="bg-[#0b86d0] text-white px-4 rounded-lg text-sm hover:bg-[#0b86d0]/90">
//                           Send
//                         </button>
//                       </div>
//                     </div>
