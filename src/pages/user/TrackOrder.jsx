...
//         return { text: 'Order Ongoing', color: 'text-yellow-600', bg: 'bg-yellow-100', icon: '⏳' }
//       case 'order_success':
//         return { text: 'Payment Successful', color: 'text-blue-600', bg: 'bg-blue-100', icon: '✓' }
//       case 'order_assigned':
//         return { text: 'Technician Assigned', color: 'text-purple-600', bg: 'bg-purple-100', icon: '👨‍🔧' }
//       case 'order_completed':
//         return { text: 'Order Completed', color: 'text-green-600', bg: 'bg-green-100', icon: '✅' }
//       case 'order_cancelled':
//         return { text: 'Order Cancelled', color: 'text-red-600', bg: 'bg-red-100', icon: '❌' }
...
//   // Timeline steps based on order type and status
//   const getTimelineSteps = () => {
...
//         { 
//           label: 'Order Placed', 
//           statusKey: 'order_ongoing',
//           status: getStepStatus('order_ongoing', status)
//         },
//         { 
//           label: 'Payment Success', 
//           statusKey: 'order_success',
//           status: getStepStatus('order_success', status)
//         },
//         { 
//           label: 'Technician Assigned', 
//           statusKey: 'order_assigned',
//           status: getStepStatus('order_assigned', status)
//         },
//         { 
//           label: 'Service Completed', 
//           statusKey: 'order_completed',
//           status: getStepStatus('order_completed', status)
//         }
//       ]
//       return steps
//     } else {
...
//     if (currentStatus === 'order_cancelled') return 'cancelled'
    
//     const statusOrder = type === 'service' 
//       ? ['order_ongoing', 'order_success', 'order_assigned', 'order_completed']
//       : ['order_ongoing', 'order_success', 'order_completed']
