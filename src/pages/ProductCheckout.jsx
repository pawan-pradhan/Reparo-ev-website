          ...
          <div className="lg:w-5/12">
            <div className="checkout-card bg-white rounded-xl shadow-md p-6 sticky top-24">
              ...
              <div className="flex justify-between mt-3">
                ...
                <h5 className="font-bold text-lg text-primary">₹{Math.round(total)}</h5>
              </div>
            </div>
          </div>
        </div>
...
//       // Prepare order payload with multiple products
//       const orderPayload = {
//         items: cartItems.map(item => ({
...
//       // Replace with actual product order API endpoint
//       const response = await fetch('https://reparo24.com/web/create_product_order', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
