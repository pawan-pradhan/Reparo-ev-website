...
//       if (data.success && data.data && data.data.length > 0) {
//         const formattedProducts = data.data.map(product => {
//           // ✅ Debug: Check what image URL we're getting
//           let imageUrl = '/assets/products/shop.png'
...
//             // Use the first path, but log for debugging
//             imageUrl = possiblePaths[0]
//             console.log(`Product: ${product.product_name}, Image: ${product.image}, URL: ${imageUrl}`)
//           }
